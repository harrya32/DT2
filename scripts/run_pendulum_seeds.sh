...
for seed in "${SEEDS[@]}"; do
    ...
    python exps/pendulum_pipeline.py --dynamics-loss "mse" --force-policy-training --force-dataset-collection --force-q-training --force-dynamics-training --seed "$seed" "${EXTRA_ARGS[@]}"
