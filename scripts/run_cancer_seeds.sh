...
for seed in "${SEEDS[@]}"; do
    ...
    python exps/cancer_pipeline.py --backbone "ode" --dyn-hidden-dim 128 --force-dynamics-training --dyn-early-stop-patience 20 --eval-rollouts 10 --seed "$seed" "${EXTRA_ARGS[@]}"
