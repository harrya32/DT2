...
DEFAULT_SEEDS=(2001 2002 2003 2004 2005 2006 2007 2008 2009)
SEEDS=("${DEFAULT_SEEDS[@]}")
EXTRA_ARGS=()
...
for seed in "${SEEDS[@]}"; do
    ...
    python exps/hopper_runner.py --dynamics-models morel --force-dynamics-training --eval-rollouts 20 --seed "$seed" "${EXTRA_ARGS[@]}"
