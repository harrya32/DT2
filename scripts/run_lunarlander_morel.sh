...
for seed in "${SEEDS[@]}"; do
    ...
    python exps/lunarlander_runner.py --dynamics-models morel --force-dynamics-training --morel-epochs 2000 --dyn-early-stop-patience 20 --eval-rollouts 20 --seed "$seed" "${EXTRA_ARGS[@]}"
