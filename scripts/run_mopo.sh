...
DEFAULT_SEEDS=(3000 3001 3002 3003 3004)
SEEDS=("${DEFAULT_SEEDS[@]}")
EXTRA_ARGS=()
...
for seed in "${SEEDS[@]}"; do
    ...
    python exps/walker_runner.py --dynamics-models mopo --force-dynamics-training --eval-rollouts 20 --seed "$seed" 
    python exps/cheetah_runner.py --dynamics-models mopo --force-dynamics-training --eval-rollouts 20 --seed "$seed" "${EXTRA_ARGS[@]}"
    python exps/ant_runner.py --dynamics-models mopo --force-dynamics-training --eval-rollouts 20 --seed "$seed"
