...
for seed in "${SEEDS[@]}"; do
    ...
    python exps/ant_runner.py --backbone "mlp" --value-aware-only --dyn-hidden-dim 64 --force-dynamics-training --dyn-early-stop-patience 20 --eval-rollouts 20 --seed "$seed" "${EXTRA_ARGS[@]}"
