...
for seed in "${SEEDS[@]}"; do
    ...
    python exps/lunarlander_runner.py --backbone "transformer" --dyn-seq-len 8 --force-dynamics-training --dyn-early-stop-patience 20 --eval-rollouts 10 --seed "$seed" "${EXTRA_ARGS[@]}"
