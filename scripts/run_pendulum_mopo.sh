...
for seed in "${SEEDS[@]}"; do
    ...
    python exps/pendulum_runner.py --dynamics-models mopo --force-dynamics-training  --mopo-epochs 2000 --dyn-early-stop-patience 20 --eval-rollouts 20 --seed "$seed" "${EXTRA_ARGS[@]}"
